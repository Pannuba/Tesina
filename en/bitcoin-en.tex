...
I've been interested in Bitcoin and cryptocurrencies ever since I got to know about them in summer 2017.\\

\medskip
\noindent
%
The technical aspect, the role in financial markets, the impact on society... I find everything so interesting that I spend a good part of my free time reading news, articles, opinions and debates on this subject / the/this argument?.\\

\medskip
\noindent
%
Cryptocurrencies are a new invention that \textbf{COINCIDE} with the beginning of a new chapter in IT, maybe even in socio(?)-economics.\\

\medskip
\noindent
%
The newness(??) of the subject made me think that this might be an interesting theme to elaborate for the maturity(lol)'s thesis.\\

\medskip
\noindent
%
I chose it mainly for passion, but also to have the opportunity to write in a single text every concept regarding cryptocurrencies, explaining them in a detailed yet not excessively complex manner/way, something/which I haven't been able to find anywhere else.\\ %in a detailes way but at the same time not excessively complex...

\medskip
\noindent
%
I hope the readers find the thesis interesting, even though I realize that certain parts can/may be technically complex.
...
\paragraph {Comparison with "traditional" money}
...
%È naturale porsi la domanda: "Ma se qualcuno, creando il proprio indirizzo, "ottenesse" la mia chiave privata sarebbe in grado di rubarmi tutti i soldi! Non è rischioso?".
%Ebbene, come ho scritto prima, esistono $2^{256}$ chiavi, un numero talmente grande che è inconcepibile dal cervello umano. La probabilità è praticamente nulla.
