...
%TODO: lighting, forse rimettere elizavetovka e rivedere crisi 29, crash
...
Il Lightning Network è un'infrastruttura esterna alla blockchain che rende cose veloci
...
Non è l'unico vantaggio.%https://www.reddit.com/r/nanocurrency/comments/830ax6/how_does_nano_not_require_mining/
...
\vspace {0.4cm}
\begin{figure}[htb!]
\makebox [\textwidth] [c] {\includegraphics [width = 14cm] {crash.png}}
\centering
%\captionsetup{width=1.4\linewidth}
...
%\vspace {0.5cm}
%\begin{figure}[htb!]
%\includegraphics [width = 8cm] {crash2.png}
%\centering
%\captionsetup{width=1.4\linewidth}
%\caption {Confronto tra il crollo del prezzo del Bitcoin nel 2013 e nel 2017\\\textit{fonte: coinmarketcap.com}}
%\end{figure}
%\vspace {0.2cm}
%\noindent
%
%Di certo non ci si dovrebbe basare sull'andamento del prezzo del passato per prevedere 
...
%\paragraph {FUD sul ban di India e Corea del Sud}
%
%Nell'aprile del 2018 \cite{indiafud}.
%\cite{indianot}
%\smallskip
%Nel dicembre del 2017 sono stati pubblicati articoli che affermavano che il governo della Corea del Sud avesse proibito lo scambio di Bitcoin \cite{koreafud}.
%È stato poi scoperto che la Corea del Sud non stava facendo altro che vietare lo scambio di Bitcoin tramite account anonimi per rendere i mercati più stabili e %sicuri \cite{koreanot}.
%Questi non sono altro che tentativi di FUD, storie inventate per dare una cattiva immagine al Bitcoin che portano a un abbassamento del prezzo.
...
Dal primo agosto del 2017, però, quando è stato lanciato Bitcoin Cash, Roger è stato l'esponente principale per il marketing di questa valuta. BCH è nato in Cina, infatti i suoi CEO sono cinesi, e Roger dev'essere stato impiegato per fare propaganda a BCH.
Tutto ciò non sembra alcunché di preoccupante: è normale se un imprenditore pubblicizza i propri investimenti sperando di ricavare più guadagni, (nel caso che...) ed è normale che sviluppatori paghino una figura eloquente e carismatica per pubblcizzare un prodotto; è così che funziona il marketing.
...
Questi due problemi sono stati per la maggior parte con l'adozione in costante crescita di SegWit\footnote{Vedi punto 3.3.3}.
...
Questo è solo un esempio delle molteplici mezze verità e bugie presenti sul bitcoin.com.
...
Una difficoltà così elevata di \textit{mining} porta necessariamente a una centralizzazione dell'\textit{hashing power}, che va contro il concetto di Bitcoin e di criptovalute in generale. inoltre, MANCA \cite{bigblocks}
Roger è entrato in possesso del sito bitcoin.com, che su numerose pagine ripete come BCH è una versione aggiornata di BTC. Una cosa che irrita la stragrande maggioranza delle persone è il fatto che su bitcoin.com il Bitcoin originale, BTC, è chiamato Bitcoin Core.
