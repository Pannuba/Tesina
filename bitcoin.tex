...
\graphicspath { {./media/} }
%TODO:DEFINIZIONE STALE BLOCK, MEMPOOL + GRAFICO, PRIVATE KEY (QUANTE, RELAZIONE CON PUBLIC), N TOT ADDRESSES O KEYS, PROBABILITA(WIKI)BLOCCHI
...
Un indirizzo Bitcoin può essere visto come un codice IBAN se si vuole rimanere in un contesto finanziario, o anche come un indirizzo email.
...
\paragraph {Seeds} %https://en.bitcoin.it/wiki/Deterministic_wallet
