...
Come uno può immaginare, indovinare una combinazione di 64 numeri e lettere è incredibilmente difficile: si pensi che esistono ben  \textasciitilde 3.433683820292513 $\times 10^{1094}$ possibili hash da indovinare.
Il miner di Bitcoin che si usa oggi lavora a \textasciitilde 13.5 TH/s (tera-hash al secondo), ovvero PIU DI TREDICI TRILIONI DI TENTATIVI IN UN SECONDO.
...
I miner ASIC usano una notevole quantità di energia elettrica, tanto che CRITOCA A USO ELE, % IN CONFRONTO A VILLAGGI&CO? QUANTITA PER NETWORK IN 1 ANNO CIRCA??
